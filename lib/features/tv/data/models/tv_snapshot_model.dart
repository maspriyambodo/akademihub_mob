...
class TvSchoolSummaryModel extends TvSchoolSummary {
  ...
  factory TvSchoolSummaryModel.fromJson(Map<String, dynamic> json) {
    ...
    if (name == null || name.isEmpty) {
      throw const FormatException('Invalid TvSchoolSummary');
    }
    return TvSchoolSummaryModel(
      name: name,
      logoUrl: logoUrl,
      timezone: timezone,
...
class TvDisplaySettingsModel extends TvDisplaySettings {
  const TvDisplaySettingsModel({
    required super.slideDurationSeconds,
    required super.showAttendance,
  });
  ...
  factory TvAnnouncementItemModel.fromJson(Map<String, dynamic> json) {
    ...
    return TvAnnouncementItemModel(
      ...
      startsAt: startsAtStr != null
          ? DateTime.parse(startsAtStr).toUtc()
          : null,
...
class TvAttendanceSummaryModel extends TvAttendanceSummary {
  ...
  factory TvAttendanceSummaryModel.fromJson(Map<String, dynamic> json) {
    ...
    return TvAttendanceSummaryModel(
      present: present,
      late: late,
      absent: absent,
      total: total,
...
class TvSnapshotModel extends TvSnapshot {
  ...
  factory TvSnapshotModel.fromJson(Map<String, dynamic> json) {
    ...
    final refreshAfter =
        (json['refresh_after_seconds'] as num?)?.toInt() ?? 300;
    ...
    final scheduleList =
        (json['schedule'] as List<dynamic>?)
            ?.map(
              (e) => TvScheduleItemModel.fromJson(e as Map<String, dynamic>),
            )
            .toList() ??
        [];
    final announcementsList =
        (json['announcements'] as List<dynamic>?)
            ?.map(
              (e) =>
                  TvAnnouncementItemModel.fromJson(e as Map<String, dynamic>),
            )
            .toList() ??
        [];
    final calendarList =
        (json['calendar'] as List<dynamic>?)
            ?.map(
              (e) => TvCalendarItemModel.fromJson(e as Map<String, dynamic>),
            )
            .toList() ??
        [];
    ...
    return TvSnapshotModel(
      ...
      attendance: attendanceMap != null
          ? TvAttendanceSummaryModel.fromJson(attendanceMap)
          : null,
    );
  }
  ...
  Map<String, dynamic> toJson() => {
    ...
    'device': {'id': device.id, 'name': device.name, 'mode': device.mode},
    'school': {
      'name': school.name,
