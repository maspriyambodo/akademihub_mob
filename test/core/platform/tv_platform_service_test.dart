...
void main() {
  ...
  group('TvPlatformService', () {
    ...
    test('isTelevision returns false when native method returns false', () async {
      TestDefaultBinaryMessengerBinding.instance.defaultBinaryMessenger
          .setMockMethodCallHandler(channel, (call) async {
    ...
    test('isTelevision returns false when native method returns null', () async {
      TestDefaultBinaryMessengerBinding.instance.defaultBinaryMessenger
    ...
    test('isTelevision returns false when native call throws PlatformException', () async {
      TestDefaultBinaryMessengerBinding.instance.defaultBinaryMessenger
          .setMockMethodCallHandler(channel, (call) async {
        throw PlatformException(code: 'UNAVAILABLE', message: 'Not android');
      });
    ...
    test('isTelevision returns false when native call throws MissingPluginException', () async {
      TestDefaultBinaryMessengerBinding.instance.defaultBinaryMessenger
          .setMockMethodCallHandler(channel, (call) async {
    ...
    test('applyTvDisplayMode invokes system orientations and immersive mode', () async {
      ...
      expect(
        log.any((call) =>
            ...
            (call.arguments as List).contains('DeviceOrientation.landscapeRight')),
        isTrue,
      );
      expect(
        log.any((call) =>
    ...
    test('restoreImmersiveMode invokes immersiveSticky system UI mode', () async {
      final log = <MethodCall>[];
      TestDefaultBinaryMessengerBinding.instance.defaultBinaryMessenger
          .setMockMethodCallHandler(SystemChannels.platform, (call) async {
        log.add(call);
